...
public class creditoDAO
{
	...
	public String UpdateProducto(Producto prod)
	{
		...
		try
		{
			...
			if (outId > 0)
				ret = "Se actualizó correctamente con el Id: " + outId;
	...
	public String SetPlazo(plazo pla)
	{
		...
		try
		{
			...
			if (outId > 0)
				ret = "Se registró correctamente con el Id: " + outId;
	...
	public String UpdatePlazo(plazo pla)
	{
		...
		try
		{
			...
			if (outId > 0)
				ret = "Se actualizó correctamente el registro con el Id: " + outId;
